...
class TestSearchLocators:
      ...
      for locator in locators['css'].keys():
         ids[locator] = (By.CSS.CSS_SELECTOR, locators['css'][locator])     
...
class OperationsHelper(BasePage):
    ...
    def click_login_button(self):
        self.click_button(TestSearchLocators.ids['LOCATOR_LOGIN_BIN'], description='login')
    ...
    def click_contact_us_button(self):
        self.click_button(TestSearchLocators.ids['LOCATOR_CONTACT_US_BIN'], description='contact us')
    ...
    def get_alert_text(self):
       alert = set.driver.switch_to.alert
       try:
          text = alert.text
       except:
